...
const LeagueOfLegendsBanner = () => {
  return (
    <div className="relative w-full flex ">
      ...
      {/* Overlay content */}
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-end md:justify-center pl-6 md:pl-40 pb-10 md:pb-0 mt-14">
        <div className="max-w-sm text-white ">
          <h1 className="text-4xl font-extrabold mb-3">Ruined King</h1>
          <p className="text-gray-300 mb-5 text-[10px] pr-20">
          ...
          <div className="flex space-x-3">
            <div>
              <div className="text-sm text-gray-400 mr-3">Reviews 3,4k</div>
